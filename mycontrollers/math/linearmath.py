...
class LSOnlyGraph:
    ...
    def __init__(
        ...
        # ==============================================================================
        '''
        set params characteristics at all plots
        and subplots for implements latext
        '''
        params = {
            'text.latex.preamble': [
        ...
        Each subplot sharing (showing) the
        ...
        print(
            "Coeficiente (m):",
            list(zip(X.columns, modelo.coef_.flatten(),))
        )
        ...
        # ==============================================================================
        '''
        A la matriz de predictores se le tiene que añadir
        una columna de 1s para el intercept del modelo
        '''
        ...
        # ==============================================================================
        predicciones = modelo.get_prediction(
            exog=X_train
        ...
        ax[1].plot(
            ...
            predicciones["mean"],
            linestyle='-',
            label=f"{self.m1[0][1]}x + {self.b1[0]}"
        )
        ax[1].fill_between(
            predicciones['x'],
...
class LinearSolveComp:
    ...
    def __init__(
        ...
        '''
        Show the minor grid lines with very faint
        and almost transparent grey lines
        '''
        ax[1].grid(visible=True, which='major', color='#666666', linestyle='-')
        ax[1].grid(
            visible=True,
        ...
        # ==============================================================================
        '''
        A la matriz de predictores se le tiene que añadir una
        columna de 1s para el intercept del modelo
        '''
        X_train = sm.add_constant(X_train, prepend=True)
        modelo = sm.OLS(endog=y_train, exog=X_train,)
        modelo = modelo.fit()
...
class LSOGComp:
    ...
    def __init__(
        ...
        # ==============================================================================
        '''
        set params characteristics at all
        plots and subplots for implements latext
        '''
        params = {
            'text.latex.preamble': [
                r'\usepackage{siunitx}',
...
# No error predition linearsolve
